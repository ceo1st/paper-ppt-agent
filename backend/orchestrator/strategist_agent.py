    ...
    *,
    ...
    if template_context:
        ...
        user_parts.extend([
            ...
            "- Keep cover/chapter/ending pages minimal: no paper figures, charts, multi-column evidence layouts, or detailed bullet grids on structural pages.",
            "- If a cover/chapter/ending manuscript page contains extra body text, summarize it into at most one subtitle/key phrase in Section IX; do not create cards, KPI strips, question lists, mini-agendas, or `核心问题` / `本章看点` blocks on structural pages.",
